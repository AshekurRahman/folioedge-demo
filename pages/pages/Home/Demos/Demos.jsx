            ...
            <div className="row g-5">
                <div className="col-lg-6">
                    <div className={styles._demo_item}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image1.src})`}}>
                        </div>
                ...
                <div className="col-lg-6">
                    <div className={`${styles._demo_item} ${styles._right}`}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image2.src})`}}>
                        </div>
                ...
                <div className="col-lg-6">
                    <div className={styles._demo_item}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image3.src})`}}>
                        </div>
                ...
                <div className="col-lg-6">
                    <div className={`${styles._demo_item} ${styles._right}`}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image4.src})`}}>
                        </div>
                ...
                <div className="col-lg-6">
                    <div className={styles._demo_item}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image5.src})`}}>
                        </div>
                ...
                <div className="col-lg-6">
                    <div className={`${styles._demo_item} ${styles._right}`}>
                        <div className={styles._demo_image} style={{backgroundImage: `url(${image6.src})`}}>
                        </div>
